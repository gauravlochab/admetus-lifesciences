...
const localBusinessJsonLd = {
  ...
  description:
    "WHO-GMP certified softgel capsule manufacturer in Jind, Haryana, India. Contract manufacturing, private label, and export-ready production for nutraceutical brand owners and distributors.",
