    ...
    <>
      ...
      <section className="relative min-h-[60vh] flex items-end pb-16 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1400px] w-full px-[clamp(1.5rem,4vw,4rem)]">
          <span className="label-text text-[#C8A951]">About Us</span>
          <h1
          ...
          >
            A PASSION FOR
            <br />
            <span className="text-[#C8A951]">BETTER HEALTHCARE</span>
          </h1>
      ...
      {/* Company Story */}
      <section className="py-[clamp(4rem,8vw,8rem)] bg-[#0A0A0A]">
        <div className="mx-auto max-w-[1400px] px-[clamp(1.5rem,4vw,4rem)]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <SectionReveal>
              <div className="space-y-6">
                <p className="text-[1rem] text-[#E8E0D0] leading-[1.7]">
      ...
      <section className="py-[clamp(4rem,8vw,8rem)] bg-[#141414] border-y border-white/[0.06]">
        <div className="mx-auto max-w-[1400px] px-[clamp(1.5rem,4vw,4rem)]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <SectionReveal>
              <div className="p-8 bg-[#1A1710] border border-white/[0.06] h-full">
                <Target size={28} className="text-[#C8A951] mb-6" />
                <h3
                  className="text-[#FAFAFA] uppercase text-xl"
            ...
            <SectionReveal delay={0.1}>
              <div className="p-8 bg-[#1A1710] border border-white/[0.06] h-full">
                <Eye size={28} className="text-[#C8A951] mb-6" />
                <h3
                  className="text-[#FAFAFA] uppercase text-xl"
                  style={{ fontFamily: "var(--font-instrument), Georgia, serif" }}
                >
      ...
      <section className="py-[clamp(4rem,8vw,8rem)] bg-[#0A0A0A]">
        <div className="mx-auto max-w-[1400px] px-[clamp(1.5rem,4vw,4rem)]">
          <SectionReveal>
            <span className="label-text text-[#C8A951]">Our Values</span>
            <h2
            ...
            {[
              ...
              <SectionReveal key={value.title} delay={i * 0.1}>
                <div className="p-6 bg-[#141414] border border-white/[0.06] h-full">
                  <value.icon size={24} className="text-[#C8A951] mb-4" />
                  <h3 className="text-[1rem] font-semibold text-[#FAFAFA]">{value.title}</h3>
                  <p className="mt-2 text-[0.875rem] text-[#8A8274]">{value.desc}</p>
                </div>
              </SectionReveal>
            ))}
          </div>
      ...
      {/* CTA */}
      <section className="py-[clamp(4rem,8vw,8rem)] bg-[#141414] text-center">
        <div className="mx-auto max-w-[1400px] px-[clamp(1.5rem,4vw,4rem)]">
          <SectionReveal>
            <h2
            ...
            >
              PARTNER WITH <span className="text-[#C8A951]">ADMETUS</span>
            </h2>
            ...
            <Link
              href="/contact/"
              className="mt-8 inline-flex items-center gap-2 px-8 py-4 text-sm font-semibold tracking-[0.05em] uppercase text-[#0A0A0A] bg-[#C8A951] hover:bg-[#E2CC7A] transition-colors duration-300"
            >
              Get in Touch
              <ArrowRight size={16} />
            </Link>
