...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    // Africa — Wave 3 country pages
    { url: `${BASE}/export/tanzania/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/ethiopia/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/uganda/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/rwanda/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/south-sudan/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/ghana/`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/export/senegal/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/cameroon/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/sierra-leone/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/mali/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/niger/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/chad/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/mauritania/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/egypt/`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/export/morocco/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/algeria/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/tunisia/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/libya/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/export/south-africa/`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
